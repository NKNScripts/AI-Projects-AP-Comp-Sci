...
import ch2_17.VacuumEnvironmentC;
...
public class VacuumView extends EmptyEnvironmentView {
	...
	protected VacuumEnvironment getVacuumEnv() {
		if(env instanceof  VacuumEnvironmentC) {
			return (VacuumEnvironmentC) env;
		}
		else
	...
	protected boolean isSemiClean(String location){

		return VacuumEnvironment.LocationState.SemiClean == getVacuumEnv()
				.getLocationState(location);
	}
